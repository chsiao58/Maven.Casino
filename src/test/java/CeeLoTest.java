...
//        CeeLo ceeloGame = new CeeLo(new CeeLoPlayer[]{new CeeLoPlayer()});
//
//    }
...
//        CeeLo ceeloGame = new CeeLo(null);
//        // If value of dice roll is less than number to beat game over.
//        Object dice;
//        Boolean expected = dice < getNumberToBeat();
//        Boolean actual = ceeloGame.endOfGame();
//        assertEquals( expected, actual);
//
//    }
}